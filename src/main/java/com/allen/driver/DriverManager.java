package com.allen.driver;

import com.allen.bo.AndroidDriverStatus;
import com.allen.bo.ChromeOption;
import com.allen.linux.DriverWaitRunable;
import com.allen.linux.ShellProcess;
...
public class DriverManager
{
    ...
    private String startAppiumService(int port, int bp, String devicesName) {
        ...
        String str = "/home/allen/android/node_modules/.bin/appium -p " + port + " -bp " + bp + " --device-name " + devicesName + " -U " + devicesName;
        try {
